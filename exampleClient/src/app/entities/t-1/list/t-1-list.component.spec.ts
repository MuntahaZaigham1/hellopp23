...
import { IT1, T1Service, T1DetailsComponent, T1ListComponent,
	T1NewComponent } from '../';
...
describe('T1ListComponent', () => {
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/t1/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
