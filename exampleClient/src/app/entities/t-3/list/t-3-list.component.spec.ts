...
import { IT3, T3Service, T3DetailsComponent, T3ListComponent,
	T3NewComponent } from '../';

describe('T3ListComponent', () => {
  let fixture:ComponentFixture<T3ListComponent>;
  let component:T3ListComponent;
  let el: HTMLElement;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(T3ListComponent);
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 't3', component: T3ListComponent },
            { path: 't3/:id', component: T3DetailsComponent }
          ])
        ],
        providers: [
          T3Service,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/t3/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
