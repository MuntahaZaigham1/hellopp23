...
import { IT3, T3Service, T3DetailsComponent, T3ListComponent } from '../';
...
describe('T3DetailsComponent', () => {
  let component: T3DetailsComponent;
  let fixture: ComponentFixture<T3DetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(T3DetailsComponent);
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 't3', component: T3DetailsComponent },
            { path: 't3/:id', component: T3ListComponent }
          ])
        ],
        providers: [
          T3Service
