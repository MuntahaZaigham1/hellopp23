...
import { IT3,T3Service, T3NewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('T3NewComponent', () => {
  let component: T3NewComponent;
  let fixture: ComponentFixture<T3NewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(T3NewComponent);
