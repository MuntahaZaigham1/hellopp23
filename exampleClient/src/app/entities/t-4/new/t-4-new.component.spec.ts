...
import { IT4,T4Service, T4NewComponent } from '../';
import { DateUtils } from 'src/app/common/shared';
import { NewComponent, FieldsComp } from 'src/app/common/general-components';

describe('T4NewComponent', () => {
  let component: T4NewComponent;
  let fixture: ComponentFixture<T4NewComponent>;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(T4NewComponent);
