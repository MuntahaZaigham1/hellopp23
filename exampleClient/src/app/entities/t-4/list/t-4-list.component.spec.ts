...
import { IT4, T4Service, T4DetailsComponent, T4ListComponent,
	T4NewComponent } from '../';

describe('T4ListComponent', () => {
  let fixture:ComponentFixture<T4ListComponent>;
  let component:T4ListComponent;
  let el: HTMLElement;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(T4ListComponent);
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 't4', component: T4ListComponent },
            { path: 't4/:id', component: T4DetailsComponent }
          ])
        ],
        providers: [
          T4Service,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/t4/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
