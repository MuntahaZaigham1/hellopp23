...
import { IT4, T4Service, T4DetailsComponent, T4ListComponent } from '../';
...
describe('T4DetailsComponent', () => {
  let component: T4DetailsComponent;
  let fixture: ComponentFixture<T4DetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(T4DetailsComponent);
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 't4', component: T4DetailsComponent },
            { path: 't4/:id', component: T4ListComponent }
          ])
        ],
        providers: [
          T4Service
